# [Simulacro MTC Application](https://simulacro-mtc.net.pe/)

[Simulacro MTC](https://simulacro-mtc.net.pe/), es una aplicación web desarrollada para la preparación en el Examen de Reglas de Tránsito (Conocimientos) requerido para obtener la Licencia de Conducir (brevete) y categorías superiores en el Perú. [Ver más](https://simulacro-mtc.github.io/).
